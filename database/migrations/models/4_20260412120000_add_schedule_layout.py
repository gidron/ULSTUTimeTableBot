...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "schedule_layout" VARCHAR(16) NOT NULL DEFAULT 'horizontal';
    """


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "user" DROP COLUMN IF EXISTS "schedule_layout";
    """
