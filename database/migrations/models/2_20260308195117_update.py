...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "user" ALTER COLUMN "group_name" DROP NOT NULL;
        ALTER TABLE "user" ALTER COLUMN "last_day_online" SET DEFAULT '2026-03-08 19:51:17.112204';"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "user" ALTER COLUMN "group_name" SET NOT NULL;
